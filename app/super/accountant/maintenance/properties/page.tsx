...
import { Search, Grid, List, X, Inbox, Plus, Eye, Building2, Edit2 } from "lucide-react";
...
export default function PropertiesPage() {
  ...
  const filteredProperties = useMemo(() => {
    ...
    return filtered;
  }, [properties, searchQuery, statusFilter, propertyTypeFilter]);
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [statusFilter, propertyTypeFilter, searchQuery, viewMode]);
