...
function exportToExcel(
  ...
  const worksheetData = [
    ...
    [
      ...
      totalOccurrences ? (totalLateMinutes / totalOccurrences).toFixed(1) : 0
    ],
    ...
    [],
    // ===== FOOTER =====
    ['This document is an official report generated by ABIC Realty and Consultancy.']
  ]
