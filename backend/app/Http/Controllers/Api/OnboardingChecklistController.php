...
class OnboardingChecklistController extends Controller
{
    ...
    private function formatChecklist(OnboardingChecklist $checklist): array
    {
    ...
    public function store(Request $request)
    {
        try {
            ...
            $onboardingChecklist = OnboardingChecklist::create($payload);

            return response()->json([
                'success' => true,
                'message' => 'Onboarding checklist created successfully',
                'data' => $this->formatChecklist($onboardingChecklist),
            ], 201);
