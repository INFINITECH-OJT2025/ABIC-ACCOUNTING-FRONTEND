...
const ALL_NAV_ITEMS: NavItem[] = [
  ...
  { href: "/super/employee/masterfile", label: "Masterfile", icon: <User className="w-4 h-4" />, category: "Employee" },
  { href: "/super/employee/onboard", label: "Onboard Employee", icon: <User className="w-4 h-4" />, category: "Employee" },
  { href: "/super/employee/terminate", label: "Terminate Employee", icon: <User className="w-4 h-4" />, category: "Employee" },
  { href: "/super/employee/evaluation", label: "Evaluation", icon: <FileText className="w-4 h-4" />, category: "Employee" },
  { href: "/super/forms/onboarding-checklist", label: "Onboarding Checklist", icon: <FileText className="w-4 h-4" />, category: "Forms" },
  { href: "/super/forms/clearance-checklist", label: "Clearance Checklist", icon: <FileText className="w-4 h-4" />, category: "Forms" },
  { href: "/super/directory/process", label: "Process", icon: <FileText className="w-4 h-4" />, category: "Directory" },
  { href: "/super/directory/contacts", label: "Contacts", icon: <User className="w-4 h-4" />, category: "Directory" },
  { href: "/super/attendance/tardiness", label: "Tardiness", icon: <Clock className="w-4 h-4" />, category: "Attendance" },
  { href: "/super/attendance/leave", label: "Leave", icon: <Calendar className="w-4 h-4" />, category: "Attendance" },
  { href: "/super/attendance/leave-credits", label: "Leave Credits", icon: <Calendar className="w-4 h-4" />, category: "Attendance" },
  ...
  { href: "/super/accountant/maintenance/banks", label: "Banks", icon: <Banknote className="w-4 h-4" />, category: "Accountant" },
