...
export default function AdminHeadSidebar() {
  ...
  return (
    <div className={`${isCollapsed ? 'w-20' : 'w-64'} bg-gradient-to-b from-[#4A081A] via-[#630C22] to-[#7B0F2B] text-white min-h-screen p-4 flex flex-col shadow-2xl transition-all duration-300 ease-in-out relative z-50`}>
      {/* Toggle Button */}
      <button
